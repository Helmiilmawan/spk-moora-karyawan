...
<div class="container py-2">
    ...
    <div class="mb-4 animate-fade text-center">
        <h3 class="fw-bold text-dark">
            <i class="bi bi-sliders text-primary"></i> Tambah Kriteria
        </h3>
        <p class="text-muted">Isi data kriteria untuk proses analisis MOORA.</p>
    </div>
        ...
        <div class="card-body p-4">
            ...
            <form action="{{ route('criteria.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold text-dark">
                            <i class="bi bi-diagram-3 text-warning"></i> Tipe Kriteria
                        </label>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="weight" step="0.01" min="0" max="1"
                               class="form-control form-control-lg rounded-3" placeholder="Contoh: 0.20" required>
                    </div>
                </div>
                ...
                <p class="text-muted text-center small mb-4">Tambahkan tingkat komponen penilaian atau skor detail untuk kriteria ini.</p>
                ...
                <div id="sub-criteria-wrapper">
                    ...
                    <div class="row g-2 mb-2 sub-item align-items-center">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="sub_label[]" class="form-control" placeholder="Deskripsi (contoh: Sangat Murah)" required>
                        </div>
                ...
                <div class="d-flex justify-content-end mt-4 gap-2">
                    ...
                    <button type="submit" class="btn btn-primary px-4 rounded-3 shadow-sm">
                        <i class="bi bi-check-circle-fill"></i> Simpan Kriteria
                    </button>
                </div>
